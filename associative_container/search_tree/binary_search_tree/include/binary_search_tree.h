...
namespace __detail {
    ...
    class bst_impl {
        ...
        static void post_search(binary_search_tree<tkey, tvalue, compare, tag> &cont,
        ...
        //template<typename tkey, typename tvalue, typename compare, typename tag>
        static void update_parent_link(
                binary_search_tree<tkey, tvalue, compare, tag> &cont,
                typename binary_search_tree<tkey, tvalue, compare, tag>::node *old_child,
                typename binary_search_tree<tkey, tvalue, compare, tag>::node *new_child
        );
    };
}
...
template<typename tkey, typename tvalue, compator<tkey> compare, typename tag>
binary_search_tree<tkey, tvalue, compare, tag>::prefix_iterator::prefix_iterator(node *data, node *backup): _data(data),
                                                                                                            _backup(backup) {
}
...
binary_search_tree<tkey, tvalue, compare, tag>::prefix_iterator::operator++() & noexcept {
    ...
    _data = (parent == nullptr) ? nullptr : parent->right_subtree;
    return *this;
}
...
binary_search_tree<tkey, tvalue, compare, tag>::prefix_iterator::operator--() & noexcept {
    ...
    if (parent->right_subtree == _data) {
        node *current = parent->left_subtree;
        while (current->right_subtree != nullptr || current->left_subtree != nullptr) {
            current = (current->right_subtree != nullptr) ? current->right_subtree : current->left_subtree;
        }
        _data = current;
    }
    return *this;
...
binary_search_tree<tkey, tvalue, compare, tag>::prefix_iterator::operator*() {
    if (_data == nullptr) throw std::out_of_range("dereferencing null-pointer");
    return _data->data;
}
...
binary_search_tree<tkey, tvalue, compare, tag>::prefix_reverse_iterator::prefix_reverse_iterator(
        const prefix_iterator &it) noexcept: _base(it) {
    --_base;
}
...
binary_search_tree<tkey, tvalue, compare, tag>::prefix_reverse_iterator::operator binary_search_tree<tkey, tvalue, compare, tag>::prefix_iterator() const noexcept {
    const prefix_iterator temp = _base;
    ++temp;
    return temp;
}
...
binary_search_tree<tkey, tvalue, compare, tag>::prefix_const_reverse_iterator::operator binary_search_tree<tkey, tvalue, compare, tag>::prefix_const_iterator() const noexcept {
    const prefix_const_iterator temp = _base;
    ++temp;
    return temp;
}
...
template<typename tkey, typename tvalue, compator<tkey> compare, typename tag>
binary_search_tree<tkey, tvalue, compare, tag>::infix_iterator::infix_iterator(node *data, node *backup): _data(data),
                                                                                                          _backup(backup) {
}
...
binary_search_tree<tkey, tvalue, compare, tag>::infix_iterator::operator++() & noexcept {
    ...
    if (_data->right_subtree != nullptr) {
        _data = _data->right_subtree;
        while (_data->left_subtree != nullptr) _data = _data->left_subtree;
        return *this;
    }
    node *parent = _data->parent;
...
binary_search_tree<tkey, tvalue, compare, tag>::infix_iterator::operator--() & noexcept {
    ...
    if (_data->left_subtree != nullptr) {
        _data = _data->left_subtree;
        while (_data->right_subtree != nullptr) _data = _data->right_subtree;
        return *this;
    }
    node *parent = _data->parent;
...
binary_search_tree<tkey, tvalue, compare, tag>::infix_reverse_iterator::operator binary_search_tree<tkey, tvalue, compare, tag>::infix_iterator() const noexcept {
    const infix_iterator temp = _base;
    ++temp;
    return temp;
}
...
binary_search_tree<tkey, tvalue, compare, tag>::infix_const_reverse_iterator::operator binary_search_tree<tkey, tvalue, compare, tag>::infix_const_iterator() const noexcept {
    const infix_const_iterator temp = _base;
    ++temp;
    return temp;
}
...
template<typename tkey, typename tvalue, compator<tkey> compare, typename tag>
binary_search_tree<tkey, tvalue, compare, tag>::postfix_iterator::postfix_iterator(node *data, node *backup): _data(
        data), _backup(backup) {
}
...
binary_search_tree<tkey, tvalue, compare, tag>::postfix_iterator::operator++() & noexcept {
    ...
    while (_data->left_subtree != nullptr || _data->right_subtree != nullptr) {
        _data = (_data->left_subtree != nullptr) ? _data->left_subtree : _data->right_subtree;
    }
    return *this;
}
...
binary_search_tree<tkey, tvalue, compare, tag>::postfix_reverse_iterator::operator binary_search_tree<tkey, tvalue, compare, tag>::postfix_iterator() const noexcept {
    const postfix_iterator temp = _base;
    ++temp;
    return temp;
}
...
binary_search_tree<tkey, tvalue, compare, tag>::postfix_const_reverse_iterator::postfix_const_reverse_iterator(
        const node *data, const node *backup) : _base(const_cast<node *>(data), const_cast<node *>(backup)) {
}
...
binary_search_tree<tkey, tvalue, compare, tag>::postfix_const_reverse_iterator::operator binary_search_tree<tkey, tvalue, compare, tag>::postfix_const_iterator() const noexcept {
    const postfix_const_iterator temp = _base;
    ++temp;
    return temp;
}
...
binary_search_tree<tkey, tvalue, compare, tag>::binary_search_tree(
    ...
    for (auto &&val: range) {
        emplace(std::forward<decltype(val)>(val));
    }
}
...
template<typename tkey, typename tvalue, compator<tkey> compare, typename tag>
binary_search_tree<tkey, tvalue, compare, tag>::binary_search_tree(const binary_search_tree &other): compare(
        other.compare), _logger(other._logger), _allocator(other._allocator) {
...
void binary_search_tree<tkey, tvalue, compare, tag>::insert_or_assign(InputIt first, InputIt last) {
    for (InputIt iter = first; iter != last; ++iter) {
        insert_or_assign(std::forward<decltype(*iter)>(*iter));
    }
}
...
binary_search_tree<tkey, tvalue, compare, tag>::find(const tkey &key) {
    ...
    while (current != nullptr) {
        if (compare_keys(key, current->data.first)) {
            ...
            __detail::bst_impl<tkey, tvalue, compare, tag>::post_search(*this, &current);
            return infix_iterator(current);
        }
    }
    return end();
...
binary_search_tree<tkey, tvalue, compare, tag>::lower_bound(const tkey &key) const {
    ...
    return infix_const_iterator(lower);
}
...
binary_search_tree<tkey, tvalue, compare, tag>::upper_bound(const tkey &key) const {
    ...
    return infix_const_iterator(upper);
}
...
binary_search_tree<tkey, tvalue, compare, tag>::erase(infix_iterator pos) {
    ...
    if (temp->left_subtree != nullptr) {
        next = temp->left_subtree;
        while (next->right_subtree) {
            next = next->right_subtree;
        }
    } else {
        node *parent = temp->parent;
        while (parent != nullptr && temp == parent->right_subtree) {
            temp = parent;
            parent = parent->parent;
        }
        next = parent;
    ...
    return next ? infix_iterator(next) : end();
}

template<typename tkey, typename tvalue, compator<tkey> compare, typename tag>
typename binary_search_tree<tkey, tvalue, compare, tag>::infix_iterator
binary_search_tree<tkey, tvalue, compare, tag>::erase(infix_const_iterator pos) {
    if (pos == end()) throw std::out_of_range("invalid iterator");
...
binary_search_tree<tkey, tvalue, compare, tag>::begin() noexcept {
    ...
    node *current = _root;
    while (current->left_subtree != nullptr) current = current->left_subtree;
    return infix_iterator(current);
}
...
binary_search_tree<tkey, tvalue, compare, tag>::end() noexcept {
    if (_root == nullptr) return infix_iterator(nullptr);
    node *current = _root;
    while (current->right_subtree != nullptr) current = current->right_subtree;
...
binary_search_tree<tkey, tvalue, compare, tag>::begin_postfix() noexcept {
    ...
    while (current->left_subtree != nullptr || current->right_subtree != nullptr) {
        current = (current->left_subtree != nullptr) ? current->left_subtree : current->right_subtree;
    }
...
void binary_search_tree<tkey, tvalue, compare, tag>::small_left_rotation(node *&subtree_root) noexcept
{
    ...
    node* old_parent = subtree_root->parent;
    new_root->left_subtree = subtree_root;
    subtree_root->parent = new_root;
    new_root->parent = old_parent;
    if (old_parent != nullptr) {
        if (subtree_root == old_parent->left_subtree) {
            old_parent->left_subtree = new_root;
        } else {
            old_parent->right_subtree = new_root;
        }
    }
...
void binary_search_tree<tkey, tvalue, compare, tag>::small_right_rotation(node *&subtree_root) noexcept
{
    ...
    if (old_parent != nullptr) {
        ...
        else old_parent->right_subtree = new_root;
    }
    subtree_root = new_root;
}
...
namespace __detail {
    ...
    bst_impl<tkey, tvalue, compare, tag>::create_node(binary_search_tree<tkey, tvalue, compare, tag> &cont,
                                                      Args &&...args) {
        using node_name = typename binary_search_tree<tkey, tvalue, compare, tag>::node;
    ...
    void bst_impl<tkey, tvalue, compare, tag>::erase(
        ...
        using node_name = typename binary_search_tree<tkey, tvalue, compare, tag>::node;
        node_name *node = *node_ptr;
        if (node == nullptr) return;
        if (node->left_subtree == nullptr && node->right_subtree == nullptr) {
            update_parent_link(cont, node, nullptr);
            delete_node(cont, node_ptr);
            return;
        }
        if (node->left_subtree == nullptr || node->right_subtree == nullptr) {
            node_name *child = node->left_subtree ? node->left_subtree : node->right_subtree;
            update_parent_link(cont, node, child);
            delete_node(cont, node_ptr);
            *node_ptr = child;
            return;
        }
        node_name **new_node_ptr = &(node->left_subtree);
        while ((*new_node_ptr)->right_subtree != nullptr) {
            new_node_ptr = &((*new_node_ptr)->right_subtree);
        }
        node_name *new_node = *new_node_ptr;
        *new_node_ptr = new_node->left_subtree;
        if (new_node->left_subtree != nullptr) {
            new_node->left_subtree->parent = new_node->parent;
        }
        new_node->left_subtree = node->left_subtree;
        new_node->right_subtree = node->right_subtree;
        new_node->parent = node->parent;
        if (new_node->left_subtree != nullptr) {
            new_node->left_subtree->parent = new_node;
        }
        if (new_node->right_subtree != nullptr) {
            new_node->right_subtree->parent = new_node;
        }
        update_parent_link(cont, node, new_node);
        delete_node(cont, node_ptr);
        *node_ptr = new_node;
    }

    template<typename tkey, typename tvalue, typename compare, typename tag>
    void bst_impl<tkey, tvalue, compare, tag>::update_parent_link(
            binary_search_tree<tkey, tvalue, compare, tag> &cont,
            typename binary_search_tree<tkey, tvalue, compare, tag>::node *old_child,
            typename binary_search_tree<tkey, tvalue, compare, tag>::node *new_child
    ) {
        if (old_child->parent != nullptr) {
            if (old_child->parent->left_subtree == old_child) {
                old_child->parent->left_subtree = new_child;
            } else {
                old_child->parent->right_subtree = new_child;
            }
        } else {
            cont._root = new_child;
        }
